...
Route::get('/played2', 'Played2Controller@index');
Route::get('/played2/create', 'Played2Controller@create');
Route::post('/played2', 'Played2Controller@store');
Route::get('played2/{id}/edit', 'Played2Controller@edit');
Route::patch('played2/{id}', 'Played2Controller@update');
Route::delete('played2/{id}', 'Played2Controller@destroy');